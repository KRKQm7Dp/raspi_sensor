...
def byteToHuman(b):
    ...
    if b == 0:
        ...
        return str('%.1f' % (b / math.pow(1024, e))) + s[e] + "/s"
...
while True:
    ...
    cmd = "ifconfig eth0 | grep bytes | awk 'NR==1{print $5}'"
    down_rate1 = int(subprocess.check_output(cmd, shell=True).decode("utf-8"))
    cmd = "ifconfig eth0 | grep bytes | awk 'NR==2{print $5}'"
    ...
    up_rate = up_rate2-up_rate1
    down_rate = down_rate2-down_rate1
